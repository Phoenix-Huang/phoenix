...
public class CustomerATest {
	...
	public void setUp() throws Exception {
		...
		URL path = getClass().getResource("/testJoinQueueA.txt");
	...
	public void testJoinQueue() throws Exception {
		...
		assertSame(this.customer, this.registers.get(0).getCustomerQueue().peekLast());		
	}
	...
	public void testSetGetArriveTime() throws Exception {
		...
		customerA.setArriveTime(2);
		assertEquals(customerA.getArriveTime(),2);
	}
	...
	public void testSetItemCount() throws Exception {
		...
		Customer customerA = new CustomerA();
		customerA.setItemCount(BigDecimal.valueOf(5));		
		assertTrue(customerA.getItemCount()
	...
	public void testGetItemCount() throws Exception {
		...
		Customer customerA = new CustomerA();
		customerA.setItemCount(BigDecimal.valueOf(4.5));		
		assertTrue(customerA.getItemCount()
	...
	public void testReduceItemCount() throws Exception {
		Customer customerA = new CustomerA();
		customerA.setItemCount(BigDecimal.valueOf(4.5));		
		customerA.reduceItemCount(BigDecimal.valueOf(1.5));
		assertTrue(customerA.getItemCount()
	...
	public void testGetPriorityRank() throws Exception {
		assertEquals(20, this.customer.getPriorityRank());
	}
